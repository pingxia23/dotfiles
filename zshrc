...
alias claude_normal="ddtool auth login --datacenter us1.ddbuild.io && claude --model claude-opus-4-6 --effort medium --allow-dangerously-skip-permissions"
alias claude_high="ddtool auth login --datacenter us1.ddbuild.io && claude --model claude-opus-4-6 --effort high --allow-dangerously-skip-permissions"
alias claude_max="ddtool auth login --datacenter us1.ddbuild.io && claude --model claude-opus-4-6 --effort max --allow-dangerously-skip-permissions"
